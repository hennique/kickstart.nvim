...
do
  ...
  -- Set the default tab indent to 4
  vim.o.tabstop = 4
  vim.o.shiftwidth = 4
...
do
  ...
  require('gitsigns').setup {
    signs = {
      add = { hl = 'GitSignsAdd', text = '┃' }, ---@diagnostic disable-line: missing-fields
      change = { hl = 'GitSignsChange', text = '┃' }, ---@diagnostic disable-line: missing-fields
      delete = { hl = 'GitSignsDelete', text = '_' }, ---@diagnostic disable-line: missing-fields
      topdelete = { text = '‾' }, ---@diagnostic disable-line: missing-fields
      changedelete = { text = '~' }, ---@diagnostic disable-line: missing-fields
    },
    signs_staged = {
      add = { hl = 'GitSignsStagedAdd', text = '┃' }, ---@diagnostic disable-line: missing-fields
      change = { hl = 'GitSignsStagedChange', text = '┃' }, ---@diagnostic disable-line: missing-fields
      delete = { hl = 'GitSignsStagedDelete', text = '_' }, ---@diagnostic disable-line: missing-fields
      topdelete = { text = '‾' }, ---@diagnostic disable-line: missing-fields
      changedelete = { text = '~' }, ---@diagnostic disable-line: missing-fields
    },
...
do
  ...
  vim.pack.add { gh 'mfussenegger/nvim-jdtls' } -- Extension support for eclipse.jdt.ls (java)
  ...
  local servers = {
    ...
    asm_lsp = { -- The lsp searches for a .git directory to locate the root of your project. Run "git init" if your project is not already a git repository
      ...
      on_init = function()
        local asm_bin = vim.fn.stdpath 'data' .. '/mason/packages/asm-lsp/bin/asm-lsp'
